...
import 'package:clementinas_recipe_app/Screens/meal_screen.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void _searchMealPlan() async {
    ...
    MealPlan mealPlan = (await APIService.inSstance.generateMealPlan(
