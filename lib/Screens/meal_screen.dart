...
import 'package:clementinas_recipe_app/Models/meal_model.dart';
...
import 'package:clementinas_recipe_app/Screens/recipe_screen.dart';
import 'package:clementinas_recipe_app/Services/api_service.dart';
...
class _MealsScreenState extends State<MealsScreen> {
  ...
  _buildMealCard(Meal meal, int index) {
    ...
    return GestureDetector(
      onTap: () async {
        Recipe recipe =
            (await APIService.inSstance.fetchRecipe(meal.id.toString()));
        Navigator.push(
          context,
          MaterialPageRoute(
